<div class="bg-white rounded-lg shadow-md relative">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Expenditure Form</div>
    ...
    @endif
    <form wire:submit.prevent="{{ $action }}Expenditure">
        ...
        <script data-navigate-once>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('edit_expenditure', (id) => {
                    Livewire.dispatch('update_expenditure', {
                        'id': id
                    });
                })
