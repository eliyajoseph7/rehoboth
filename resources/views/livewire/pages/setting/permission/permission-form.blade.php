<div class="bg-white rounded-lg shadow-md relative">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Permissions Form</div>
    @if ($name)
    ...
    @endif
    <form wire:submit.prevent="{{ $action }}Permission">
        <div class="p-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
            <div class="col-span-full">
                <label for="classification_id" class="block text-sm font-medium leading-6 text-gray-900">Permission Class</label>
                <div class="mt-2">
                    <div wire:ignore
                        ...
                        <select type="text" id="classification" wire:model="classification_id"
            ...
            <div class="col-span-full">
                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Permission Name <span
                        class="text-red-500">*</span></label>
                <div class="mt-2">
                    <div
                        class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                        <input type="text" id="name" wire:model.live="name" wire:keyup="generateSlug"
        ...
        <script data-navigate-once>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('edit_permission', (id) => {
                    Livewire.dispatch('update_permission', {
                        'id': id
                    });
                })
