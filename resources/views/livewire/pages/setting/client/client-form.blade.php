<div class="bg-white rounded-lg shadow-md relative min-w-4xl">
    ...
    <form wire:submit.prevent="{{ $action }}Client">
        <div class="p-3">
            <div class="overflow-y-auto max-h-[300px] grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 px-1 mb-2">
                ...
                <div class="grid grid-flow-col grid-cols-1 w-full col-span-full">
                    <div class="">
                        <label for="location" class="block text-sm font-medium leading-6 text-gray-900">Location <span
                                class="text-red-500">*</span></label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                                <textarea type="text" id="location" wire:model.live="location"
                                    class="block w-full border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    placeholder="Enter ward/street e.t.c"></textarea>
                            </div>
                            <div class="text-red-500 text-sm">
                                @error('location')
                                    <span class="error">{{ $message }}</span>
            ...
            <button type="submit"
                class="block w-full bg-red-500 hover:bg-red-600 col-span-full p-2 rounded-lg text-white">
                <div wire:loading>
