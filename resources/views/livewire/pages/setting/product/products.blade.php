            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full">
                    <div class="flex justify-end pb-2">
                        <button wire:click="$dispatch('openModal', {component: 'pages.setting.product.product-form'})"
                            ...
                            <span class="">{{ __('Add Product') }}</span>
                        </button>
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Update"
                                                            wire:click="$dispatch('openModal', {component: 'pages.setting.product.product-form', arguments: {id: {{ $dt->id }}}})"
                ...
                Livewire.on('confirm_delete', (id) => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Livewire.dispatch('delete_product', {
                                'id': id
                            });
                        }
                    });
