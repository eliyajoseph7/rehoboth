<div class="bg-white rounded-lg shadow-md relative min-w-4xl">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Payment Method Form</div>
    @if ($name)
    ...
    @endif
    <form wire:submit.prevent="{{ $action }}PaymentMethod">
        <div class="p-3">
            <div class="overflow-y-auto max-h-[300px] grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 px-1">
                <div class="grid grid-flow-col grid-cols-1 w-full col-span-full">
                    <div class="">
                        <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Payment Method <span
        ...
        <script data-navigate-once>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('edit_payment_method', (id) => {
                    Livewire.dispatch('update_payment_method', {
                        'id': id
                    });
                })
