    ...
    <div>
            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full">
                    <div class="flex justify-end pb-2">
                        <button wire:click="$dispatch('openModal', {component: 'pages.setting.payment-method.payment-method-form'})"
                            ...
                            <span class="">{{ __('Add Payment Method') }}</span>
                        </button>
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Update"
                                                            wire:click="$dispatch('openModal', {component: 'pages.setting.payment-method.payment-method-form', arguments: {id: {{ $dt->id }}}})"
        ...
        <script data-navigate-once>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('confirm_delete', (id) => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Livewire.dispatch('delete_payment_method', {
                                'id': id
                            });
                        }
                    });
                ...
                Livewire.on('payment_method_deleted', () => {
                    Toast.fire({
                        icon: 'success',
                ...
                // Livewire.on('edit_payment_method', (id) => {
                //     Livewire.dispatch('update_payment_method', {'id': id});
                // })
